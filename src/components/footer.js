    ...
    <section className="bg-black">
      <div className="flex flex-col md:flex-row bg-white justify-center">
        <a
          ...
          className="text-black hover:text-red-600 p-5"
        >
          <svg
      ...
      <div className="container mx-auto p-1">
        <div className="bg-black rounded-lg shadow p-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16">
          ...
          <div className="bg-black rounded-lg shadow p-4">
            ...
            <p className="text-gray-700 text-white">
              Matriz Cuenca: Av. de las Américas y Humboldt Teléfono: +593 (07)
              4134-750 Email:
              <a
