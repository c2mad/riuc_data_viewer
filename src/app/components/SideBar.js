...
return (
  ...
  <button className='ml-4 fixed right-10 p-1 border-b border-gray-50' onClick={() => setOpen(true)}>
  ...
  <div className={`${open ? "w-80" : "w-0"} bg-black min-h-screen fixed top-0 left-0 transition-all duration-300`}>
    ...
    <div className='font-sans text-center text-white text-xl hover:bg-red-400 cursor-pointer py-3 mb-2'> 
      ...
      <a href="/labs">Laboratorios</a></div>

      <div className='font-sans text-center text-white text-xl hover:bg-red-400 cursor-pointer py-3 mb-2'>
      {/* <Link href={{pathname:"/info"}}>Información</Link> */}
      <a href="/info">Información</a></div>
      
      <div className='font-sans text-center text-white text-xl hover:bg-red-400 cursor-pointer py-3 mb-2'>Proyectos</div>
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" class="w-6 h-6">
      <path stroke-linecap="round" stroke-linejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
      </svg>
      <h1 className='font-sans text-center text-white'>ciitt@ucacue.edu.ec</h1>
