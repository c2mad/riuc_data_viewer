...
export default function Boletinn3() {
  ...
  return (
    <div className="bg-white p-6 mx-auto max-w-7xl">
      ...
      <h1 className="text-6xl text-red-500 font-semibold mb-5 mt-3">Inflación en Ecuador del último trimestre del año 2024</h1>
...
export default function Boletinn3() {
  const info = lista_infografia.find((item) => item.id === 3);
