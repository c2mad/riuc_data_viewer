...
export default function Observatorioo5() {
    ...
    <div className="container mx-auto px-6 py-12 bg-gray-50">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-gray-700 font-medium">
          Estudiando los impactos ambientales y promoviendo la sostenibilidad
        </p>
      </div>
      ...
      <section className="bg-white p-8 rounded-lg shadow-xl mb-10">
        ...
        <p className="text-lg text-gray-600 mb-6">
          El Observatorio Ambiental se dedica a la monitorización y análisis de los problemas ambientales más relevantes a
          nivel local y global. A través de estudios detallados sobre el cambio climático, la biodiversidad, la calidad del
          aire, el agua y el suelo, buscamos generar conocimiento para implementar soluciones prácticas y sostenibles.
        </p>
        ...
        <ul className="list-inside list-disc text-lg text-gray-600 mb-8">
          <li>Monitoreo del cambio climático y su impacto en los ecosistemas locales.</li>
          <li>Investigación sobre la biodiversidad y conservación de especies en peligro de extinción.</li>
          <li>Análisis de la calidad del aire y su relación con las enfermedades respiratorias.</li>
          <li>Estudios sobre el manejo sostenible del agua y los recursos naturales.</li>
        </ul>

        {/* Datos adicionales */}
        <h2 className="text-2xl font-semibold text-gray-800 mb-4">Datos Relevantes</h2>
        <p className="text-lg text-gray-600 mb-6">
          Nuestro trabajo se basa en el análisis científico riguroso y en la colaboración con instituciones nacionales e
          internacionales para promover políticas públicas efectivas en pro de un entorno más saludable y sostenible. 
          Colaboramos también con diversas ONGs y empresas para llevar a cabo proyectos que generen impacto ambiental positivo.
        </p>
      </section>
