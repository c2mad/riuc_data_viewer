  ...
  return (
    <div className="container mx-auto px-6 py-12 bg-gray-50">
      ...
      <section className="bg-white p-8 rounded-lg shadow-xl mb-10">
        <h2 className="text-3xl font-semibold text-gray-800 mb-4">Acerca del Observatorio</h2>
        ...
        <div className="space-y-6 text-lg text-gray-600 mb-8">
          ...
          <div className="bg-gray-100 p-4 rounded-lg shadow-sm mb-3">
            <h3 className="text-xl text-red-600 font-bold mb-4">📑 Reciente</h3>
          ...
          <div className="bg-gray-100 p-4 rounded-lg shadow-sm">
            <h3 className="text-xl font-bold text-yellow-700 mb-3"> Hypothesis of the hyporreic refuge: description of ecological niches in macroinvertebrates with stable isotopes in the Machangara subcuenca. </h3>
      ...
      <div className="bg-gradient-to-r from-yellow-600 to-yellow-500 text-white p-6 rounded-lg shadow-md text-center">
        ...
        <p className="text-lg mb-4">
          Contáctanos para conocer más sobre nosotros.
        </p>
        <a
