  ...
  const handleDownloadClick = async () => {
    try {
      const response = await axios.get(
        "http://192.168.10.11:8484/api/canarencuesta",
        {
                  ...
                  <>
                      ...
                      <Popup>
                        <div>
                          <h2 className="text-lg font-semibold">
                            COOPERATIVA DE PRODUCCIÓN AGROPECUARIA VIRGEN DE LA
                            NUBE{" "}
                          </h2>
                          <p>NO PRODUCE</p>
                        </div>
                    ...
                    >
                      <Popup>
                        <div>
                          <h2 className="text-lg font-semibold">
                            COOPERATIVA AGROPECUARIA SAN ISIDRO DE VENDELECHE{" "}
                          </h2>
                          <p>PAPAS, MELLOCO</p>
                        </div>
                      </Popup>
                    ...
                    >
                      <Popup>
                        <div>
                          <h2 className="text-lg font-semibold">
                            ASOCIACION DE CAÑACULTORES DE LA PROVINCIA DEL CAÑAR{" "}
                          </h2>
                          <p>BIOCOMBUSTIBLE</p>
                        </div>
                      </Popup>
                    ...
                    >
                      <Popup>
                        <div>
                          <h2 className="text-lg font-semibold">
                            ASOCIACIÓN COMUNITARIA PROGRESISTA{" "}
                          </h2>
                    ...
                    >
                      <Popup>
                        <div>
                          <h2 className="text-lg font-semibold">
                            COOPERATIVA DE PRODUCCIÓN AGROPECUARIA SAN ANDRÉS DE
                            MALAL{" "}
                          </h2>
                    ...
                    >
                      <Popup>
                        <div>
                          <h2 className="text-lg font-semibold">
                            ASOCIACIÓN DE PRODUCCIÓN GANADERA TOMAHUAYCO Y
                            SIYACOCHA{" "}
                          </h2>
                          <p>GANADOS</p>
                        </div>
                    ...
                    >
                      <Popup>
                        <div>
                          <h2 className="text-lg font-semibold">
                            ASOCIACIÓN DE PRODUCCIÓN GANADERA SISID{" "}
                          </h2>
                    ...
                    >
                      <Popup>
                        <div>
                          ...
                          <p>
                            DERIVADOS DE QUINUA, CEBADA, AMARANTO, TRIGO, HABA
                          </p>
                        </div>
                      </Popup>
                    </Circle>
                    ...
                    >
                      <Popup>
                        <div>
                          <h2 className="text-lg font-semibold">
                            ASOCIACION DE GANADEROS DE PRODUCCION CULEBRILLAS{" "}
                          </h2>
                    ...
                    >
                      <Popup>
                        <div>
                          <h2 className="text-lg font-semibold">
                            ASOCIACION DE AGRONOMOS DEL CAÑAR{" "}
                          </h2>
                    ...
                    >
                      <Popup>
                        <div>
                          <h2 className="text-lg font-semibold">
                            TEJIDOS Y ARTESANIAS ATAHUALPA{" "}
                          </h2>
                          <p>ARTESANIAS</p>
                        </div>
                      </Popup>
                    ...
                    >
                      <Popup>
                        <div>
                          <h2 className="text-lg font-semibold">
                            ASOCIACIÓN DE PRODUCCIÓN AGROPECUARIA JUNCAL{" "}
                          </h2>
                    ...
                    >
                      <Popup>
                        <div>
                          <h2 className="text-lg font-semibold">
                            ASOCIACIÓN DE PRODUCCIÓN GANADERA DE COLMENA
                            ASOPROGALACOL{" "}
                          </h2>
                          <p>Lácteos</p>
                        </div>
                    ...
                    >
                      <Popup>
                        <div>
                          <h2 className="text-lg font-semibold">
                            {" "}
                            COOPERATIVA JAIME ROLDOS AGUILERA{" "}
                          </h2>
                    ...
                    >
                      <Popup>
                        <div>
                          <h2 className="text-lg font-semibold">
                            ASOCIACIÓN DE PRODUCCIÓN ARTESANAL ÑUKA ALLPA{" "}
                          </h2>
                          <p>Tejidos.</p>
                        </div>
                      </Popup>
                    ...
                    >
                      <Popup>
                        <div>
                          <h2 className="text-lg font-semibold">
                            ASOCIACIÓN DE TRABAJADORES AGRÍCOLAS CUNGAPIE{" "}
                          </h2>
                    ...
                    >
                      <Popup>
                        <div>
                          <h2 className="text-lg font-semibold">
                            ASOCIACIÓN PRODUCCIÓN GANADERA “ SAN JOSÉ DE
                            MAZANQUI”{" "}
                          </h2>
                          <p>Leche</p>
                        </div>
                    ...
                    >
                      <Popup>
                        <div>
                          <h2 className="text-lg font-semibold">
                            ASOCIACIÓN VIRGEN DE PILAGATOS{" "}
                          </h2>
                    ...
                    >
                      <Popup>
                        <div>
                          <h2 className="text-lg font-semibold">
                            ASOCIACIÓN CAMPESINA DE PEQUEÑOS PRODUCTORES CHUYA
                            MIKUNA{" "}
                          </h2>
                    ...
                    >
                      <Popup>
                        <div>
                          <h2 className="text-lg font-semibold">
                            ASOCIACIÓN DE SERVICIOS DE RECICLAJE ARRAYAN
                            ASOSEREA{" "}
                          </h2>
                    ...
                    >
                      <Popup>
                        <div>
                          <h2 className="text-lg font-semibold">
                            ASOCIACIÓN DE PRODUCTORES AGROECOLÓGICOS QUAPAQ ÑAN{" "}
                          </h2>
                          <p>
                            Cultivo de hortalizas agroecológicas y fideos
                            Pallarina
                          </p>
                        </div>
                      </Popup>
                    ...
                    >
                      <Popup>
                        <div>
                          <h2 className="text-lg font-semibold">
                            ASOCIACIÓN DE PRODUCCIÓN GANADERA CHUGUIN LAC{" "}
                          </h2>
                          <p>Enfriadora de leche</p>
                        </div>
                      </Popup>
                    ...
                    >
                      <Popup>
                        <div>
                          <h2 className="text-lg font-semibold">
                            ASOCIACIÓN DE ARTESANAS MUSHUK PAKARY{" "}
                          </h2>
                    ...
                    >
                      <Popup>
                        <div>
                          <h2 className="text-lg font-semibold">
                            ASOCIACIÓN DE SERVICIOS DE LIMPIEZA DEL CAÑAR
                            ASOSERLICAR Servicio de lavado y accesorios para
                            vehículos{" "}
                          </h2>
